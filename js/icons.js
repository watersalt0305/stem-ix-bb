...
var ICONS = (function() {
  ...
  var PATHS = {
    ...
    // 👍 点赞（大拇指）
    thumb: '<path d="M7 10.5v9H4v-9z"/><path d="M7 11l3.5-6.5a1.8 1.8 0 0 1 3.4 1L13 10h5a2 2 0 0 1 2 2.4l-1.2 5.5a2 2 0 0 1-2 1.6H7"/>',
    // 👁 浏览（眼睛）
    eye: '<path d="M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12z"/><circle cx="12" cy="12" r="3"/>',
    // 🗑 删除（垃圾桶）
    trash: '<path d="M5 7h14M9 7V5h6v2M7 7l1 13h8l1-13"/><path d="M10 10.5v6M14 10.5v6"/>',
    // 🎭 匿名（面具）
    mask: '<path d="M4 5.5c2.5 1 5 1.5 8 1.5s5.5-.5 8-1.5v6c0 5-3.5 8.5-8 8.5s-8-3.5-8-8.5z"/><path d="M8.5 12c.6-.8 1.6-.8 2.2 0M13.3 12c.6-.8 1.6-.8 2.2 0"/>',
    // 📌 置顶（图钉）
    pin: '<path d="M9 4h6l-.7 5.2 2.2 2.3H7.5l2.2-2.3z"/><path d="M12 11.5V20"/>'
  };
