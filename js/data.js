...
// ---------- 成就系统 ----------
var ACHIEVEMENTS = [
  { id: 'first_post', title: '初来乍到', desc: '发表第一条帖子', icon: 'edit' },
  { id: 'first_reply', title: '社交达人', desc: '第一次回复帖子', icon: 'chat' },
  { id: 'first_mention', title: '点名高手', desc: '第一次@角色', icon: 'megaphone' },
  { id: 'card_3', title: '初级收藏家', desc: '收集3张角色卡', icon: 'card' },
  { id: 'card_all', title: '全员集结', desc: '收集所有角色卡', icon: 'crown' },
  { id: 'meet_legendary', title: '传说降临', desc: '遇到传说级角色', icon: 'star' },
  { id: 'meet_epic', title: '史诗邂逅', desc: '遇到史诗级角色', icon: 'starburst' },
  { id: 'night_owl', title: '夜猫子', desc: '在凌晨0-5点发帖', icon: 'moon' },
  { id: 'post_5', title: '话唠', desc: '累计发表5条帖子', icon: 'megaphone' },
  { id: 'reply_10', title: '评论鬼才', desc: '累计回复10条评论', icon: 'flame' },
];

// 成就图标渲染：icon 字段是 ICONS 库的名字；兼容旧emoji数据
function renderAchIcon(icon, size) {
  if (typeof ICONS !== 'undefined' && ICONS.has(icon)) return ICONS.get(icon, size || 24);
  return icon; // 兜底：直接显示（emoji或字符）
}
